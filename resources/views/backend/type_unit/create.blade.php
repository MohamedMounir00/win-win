...
@section('page_title' , trans('backend.type_unit_create'))
...
@section('content')
            ...
            <div class="clearfix"></div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h3>{{trans('backend.type_unit_create')}}</h3>
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::open(['route'=>['type_unit.store'],'method'=>'POST','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                                ...
                                <div id="myTabContent" class="tab-content">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        @foreach($questions as $value)
                                            <label class="col-md-6 col-sm-6 col-xs-12" >{{ Form::checkbox('q_id[]', $value->id, false, array('class' => 'name form-control col-md-7 col-xs-12')) }}
