...
@section('page_title' , trans('backend.type_unit_update'))
...
@section('content')
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h3>{{trans('backend.type_unit_update')}}</h3>
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::open(['route'=>['type_unit.update',$data->id],'method'=>'PUT','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" >{{trans('backend.quesction')}}</label>
                                    <br/>

                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        @foreach($questions as $value)
                                            <label class="col-md-6 col-sm-6 col-xs-12" >{{ Form::checkbox('q_id[]', $value->id,in_array($value->id, $rel_q) ? true : false, array('class' => 'name form-control col-md-7 col-xs-12')) }}
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <a href="{{route('type_unit.index')}}"  class="btn btn-primary">{{trans('backend.back')}}</a>
