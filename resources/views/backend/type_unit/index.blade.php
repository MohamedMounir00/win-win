...
@section('page_title' , trans('backend.type_unit'))

@section('content')

    <div class="x_panel">
            <div class="x_title">
                <h2>{{trans('backend.type_unit')}}</h2>
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li><a   href="{{route('type_unit.create')}}" class=""><i class="fa fa-plus-square"></i></a>
                    </li>
                </ul>
    ...
    <script>
        $(function() {
            $('#table1').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('type_unit.get_type_unit') !!}',
                columns: [
                    { data: 'name', name: 'name' },
