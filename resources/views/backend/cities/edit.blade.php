...
@section('page_title' , trans('backend.cities_update'))
...
@section('content')
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::open(['route'=>['cities.update',$data->id],'method'=>'PUT','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
