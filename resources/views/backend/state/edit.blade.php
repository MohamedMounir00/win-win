...
@section('page_title' , trans('backend.state_update'))
...
@section('content')
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h3>{{trans('backend.state_update')}}</h3>
                        ...
                        <div class="x_content">
                            ...
                            {!! Form::open(['route'=>['state.update',$data->id],'method'=>'PUT','class'=>'form-horizontal form-label-left ','novalidate','files'=>true]) !!}
