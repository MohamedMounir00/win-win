...
@section('page_title' , trans('backend.state_controller'))

@section('content')

    <div class="x_panel">
            <div class="x_title">
                <h2>{{trans('backend.state_controller')}}</h2>
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <li><a   href="{{route('state.create')}}" class=""><i class="fa fa-plus-square"></i></a>
                    </li>
                </ul>
