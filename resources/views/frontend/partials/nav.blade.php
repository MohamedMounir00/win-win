                ...
                <ul class="navbar-nav ml-auto">
                    @if(Auth::check())
                        ...
                        <li class="nav-item active">
                            <a href="{{route('chat')}}" class="badge1" data-badge="{{\App\Helper\Helper::count_unseen_message() > 9 ? '9+' : \App\Helper\Helper::count_unseen_message()}}"> <img src="{{url('frontend/images/chatting.svg')}} " style="width: 30px"></a>
                        </li>
