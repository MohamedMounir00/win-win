    ...
    $.fn.uploadFile = function (options) {
        ...
        (function checkAjaxFormLoaded() {
            if($.fn.ajaxForm) {
                ...
                if(s.dragDrop) {
                    var dragDrop = $('<div class="upload-image" ></div>');
                    $(obj).append(dragDrop);
                ...
                $(obj).append(obj.errorLog);
   				...
   				if(s.showQueueDiv)
		            ...
		            obj.container = $('<div class="col-xl-8 col-lg-12 col-md-12 show-images"></div>').insertAfter($(obj));
	...
	this.enqueueFile = function(file){
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            if(s.multiple) {
                ...
                fileInputStr = "<i id='profileImage' class='fa fa-camera' aria-hidden='true'></i><input style='position: absolute; cursor: pointer; top: 0px; width: 100%; height: 100%; left: 0px; z-index: 100; opacity: 0;' type='file' id=' imageUpload' name='" + s.fileName + "' accept='" + s.acceptFiles + "' multiple/> <p>Upload User Photo<span>Max 8 photos of unit</span></p>";
            }
		...
		function defaultProgressBar(obj,s)
		{
			...
			this.statusbar = $("<div class='ajax-file-upload-statusbar' style='max-width:110px'></div>");
            this.preview = $("<img class='ajax-file-upload-preview img-fluid img-thumbnail' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).hide();
